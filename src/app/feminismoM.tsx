      ...
      <View style={styles.container}>
        ...
        >
          <View style={styles.headerContainer}>
            <Text style={styles.pageTitle}>Gênero e Feminismo</Text>
            <Text style={styles.pageSubtitle}>Músicas sobre empoderamento feminino</Text>
          </View>
          ...
          <View style={styles.card}>
            ...
            <Text style={styles.cardText}>
              <Text style={styles.cardTitle}>"N.I.N.A" (Brisa Flow):</Text> 
              Sigla para "Nunca Ignore Novamente uma Atitude Machista"
            </Text>
          </View>
