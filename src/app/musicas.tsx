  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      ...
      <View style={styles.container}>
        ...
        <View>
          <Text style={styles.brain}>Músicas</Text>
        </View>

        <View style={styles.buttonsContainer}>
          <View style={styles.buttonRow}>
          
          <Link href="../desigualdadeM" asChild>
            <TouchableOpacity style={styles.button}>
              <Text style={styles.buttonText}>Desigualdade social</Text>
            </TouchableOpacity>
          </Link>  

           <Link href="../raciaisM" asChild>
            <TouchableOpacity style={styles.button}>
          ...
          <Link href="../saudeM" asChild>
            <TouchableOpacity style={styles.button}>
              <Text style={styles.buttonText}>Saúde Mental</Text>
            </TouchableOpacity>
          </Link>  
          
          <Link href="../feminismoM" asChild>
            <TouchableOpacity style={styles.button}>
              <Text style={styles.buttonText}>Feminismo e Questões de Gênero</Text>
            </TouchableOpacity>
          </Link>  
