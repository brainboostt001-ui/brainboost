...
export default function RaciaisPodcasts() {
    ...
    <SafeAreaView style={styles.safeArea}>
      ...
      <View style={styles.container}>
        ...
        <View style={styles.card}>
          ...
          <Text style={styles.cardText}>
            <Text style={styles.cardTitle}>Racismo Estrutural (Spotify):</Text> 
              Com Silvio Almeida.
          </Text>
        </View>
        ...
        <View style={styles.card}>
          ...
          <Text style={styles.cardText}>
            <Text style={styles.cardTitle}>Mulheres de Luta:</Text> 
        ...
        <View style={styles.card}>
          ...
          <Text style={styles.cardText}>
            <Text style={styles.cardTitle}>Querino (Nexo)</Text> 
        ...
        <View style={styles.card}>
          ...
          <Text style={styles.cardText}>
            <Text style={styles.cardTitle}>Afropausa:</Text> 
             Cultura negra e antirracismo.
          </Text>
        </View>
